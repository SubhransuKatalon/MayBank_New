...
WebUI.verifyElementText(findTestObject('Object Repository/Demo_SSN/Page_SSN Mart/h1_Welcome to SSN MART'), 'Welcome to SSN MART')
...
WebUI.click(findTestObject('Object Repository/Demo_SSN/Page_SSN Mart/button_Login'))
